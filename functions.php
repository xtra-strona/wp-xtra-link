...
function xtra_link_scripts() {
	...
	wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/js/jquery.js', array(), '20151215', false );

	// wp_enqueue_style( 'xtra-link-style', get_stylesheet_uri() );

	// wp_enqueue_script( 'xtra-link-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	// wp_enqueue_script( 'xtra-link-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
